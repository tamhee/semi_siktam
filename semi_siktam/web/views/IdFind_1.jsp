...
<head>
    ...
    <link rel="stylesheet" href="../resources/css/IdFind_1.css">
...
<body>
    ...
    <div id="container">
        ...
        <a href="../view/FindPassword_1.html">
            <div class="pwdDiv">
                <h1>비밀번호 찾기</h1>
                <hr class="hr">
            </div>
    ...
    <script>
        ...
        <div class="div3">
            비밀번호 찾으시나요? &nbsp;<a href="FindPassword_1.html" style="color: black;">비밀번호 찾기 (이동)</a>
        </div>
        <br>
        </div>
    </div>
